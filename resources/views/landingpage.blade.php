            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">SekolahXYZ merupakan sekolah unggulan yang berada di kota
                        ...
                        mempuni. <br /><br /></p>
                        <a
                        class="mx-auto lg:mx-0 hover:underline bg-gray-300 text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out mt-4" href="/register">
                        Register</a>
                </div>
