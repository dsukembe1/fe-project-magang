...
Route::get('adm-dashboard', [DashboardController::class,'guru'])->middleware(['auth'])->name('dashboard');
...
Route::get('adm-dafnilai', [dafNilaiController::class,'guru'])->middleware(['auth'])->name('dashboard');
Route::get('adm-nilai', [NilaiController::class,'guru'])->middleware(['auth'])->name('dashboard');
...
Route::get('adm-dafextrakulikuler', [dafExtrakulikulerController::class,'guru'])->middleware(['auth'])->name('dashboard');
Route::get('adm-extrakulikuler', [ExtrakulikulerController::class,'guru'])->middleware(['auth'])->name('dashboard');
...
Route::get('adm-dafprestasi', [dafPrestasiController::class,'guru'])->middleware(['auth'])->name('dashboard');
Route::get('adm-prestasi', [PrestasiController::class,'guru'])->middleware(['auth'])->name('dashboard');
...
Route::get('adm-dafkurikulum', [dafKurikulumController::class,'guru'])->middleware(['auth'])->name('dashboard');
Route::get('adm-kurikulum', [KurikulumController::class,'guru'])->middleware(['auth'])->name('dashboard');
...
Route::get('adm-dafrapot', [dafRapotController::class,'guru'])->middleware(['auth'])->name('dashboard');
Route::get('adm-rapot', [RapotController::class,'guru'])->middleware(['auth'])->name('dashboard');
